...
function App() {
  ...
  const [referrerEditor, setReferrerEditor] = useState<{ id: number | null; referrer_name: string; contact_email: string; contact_phone: string; referral_fee: string; marketing_fee: string; portal_email: string; portal_active: boolean; notes: string; password: string }>({
    id: null, referrer_name: "", contact_email: "", contact_phone: "",
    referral_fee: "", marketing_fee: "50", portal_email: "", portal_active: false, notes: "", password: "",
  });
  ...
  const handleSaveReferrer = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setReferrerEditor({ id: null, referrer_name: "", contact_email: "", contact_phone: "", referral_fee: "", marketing_fee: "50", portal_email: "", portal_active: false, notes: "", password: "" });
                    ...
                    <form onSubmit={(e) => void handleSaveReferrer(e)}>
                      ...
                      <div className="form-footer action-row" style={{ marginTop: "14px" }}>
                        <button type="button" className="muted-button" style={{ minHeight: 40, padding: "0 16px" }}
                          onClick={() => { setReferrerEditor({ id: null, referrer_name: "", contact_email: "", contact_phone: "", referral_fee: "", marketing_fee: "50", portal_email: "", portal_active: false, notes: "", password: "" }); setReferrerSaveMessage(""); }}>
                          Clear
                        </button>
