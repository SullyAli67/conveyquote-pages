  ...
  try {
    ...
    await env.DB.prepare(
      `INSERT INTO enquiries (
        ...
        mortgage, lender, ownership_type, first_time_buyer,
        new_build, shared_ownership, help_to_buy, is_company,
        buy_to_let, gifted_deposit, additional_property,
        uk_resident_for_sdlt, lifetime_isa,
        sale_mortgage, management_company, tenanted, number_of_sellers,
        current_lender, new_lender, additional_borrowing,
        transfer_mortgage, owners_changing,
        status, quote_json
       ) VALUES (
        ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?
       )`
